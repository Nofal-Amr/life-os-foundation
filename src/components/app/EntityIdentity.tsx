...
const ICONS: IconEntry[] = [
  ...
  { name: "plane-takeoff", label: "Departure", icon: PlaneTakeoff, keywords: "flight travel airport trip leave", group: "Travel" },
  { name: "plane-landing", label: "Arrival", icon: PlaneLanding, keywords: "flight travel airport trip return", group: "Travel" },
  { name: "tickets-plane", label: "Flight ticket", icon: TicketsPlane, keywords: "flight booking airline travel", group: "Travel" },
  { name: "hotel", label: "Hotel", icon: Hotel, keywords: "stay booking travel holiday", group: "Travel" },
  { name: "car-taxi", label: "Taxi", icon: CarTaxiFront, keywords: "uber careem ride transport", group: "Travel" },
  { name: "caravan", label: "Road trip", icon: Caravan, keywords: "travel camping holiday", group: "Travel" },
  { name: "sailboat", label: "Sailing", icon: Sailboat, keywords: "boat sea holiday", group: "Travel" },
