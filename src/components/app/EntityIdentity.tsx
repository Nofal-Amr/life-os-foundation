...
const ICONS: IconEntry[] = [
  ...
  { name: "shower", label: "Shower", icon: Shower, keywords: "water bathroom home", group: "Home" },
  ...
  { name: "table", label: "Table", icon: Table, keywords: "furniture home", group: "Home" },
  ...
  { name: "pizza-slice", label: "Pizza", icon: PizzaSlice, keywords: "takeaway fast food", group: "Food" },
  ...
  { name: "map", label: "Map", icon: Map, keywords: "travel places directions", group: "Travel" },
